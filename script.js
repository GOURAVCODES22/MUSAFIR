...
function closePanel(){
  ...
  const goHome = ()=>{
    ...
    const hero = document.getElementById('home') || document.querySelector('main') || document.body;
    if(hero && hero.scrollIntoView) hero.scrollIntoView({block:'start',behavior:'instant'});
  };
