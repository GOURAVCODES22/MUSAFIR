...
if(panelCloseBtn){
  ...
  panelCloseBtn.addEventListener('pointerdown', closeFromUser, {passive:false});
  panelCloseBtn.addEventListener('click', closeFromUser, {passive:false});
  panelCloseBtn.addEventListener('touchstart', closeFromUser, {passive:false});
}
// Final delegated fallback for browsers/WebViews that swallow a direct button event.
document.addEventListener('click', (e)=>{
  if(e.target && e.target.closest && e.target.closest('#panelClose')) closePanel();
}, true);
