...
========================================================= */
const COUNTRIES = [
  { name:"India", lat:27.1751, lon:78.0421, tz:"Asia/Kolkata", population:"1.48 billion", area:"3,287,263 km²",
  ...
  { name:"United States", lat:40.7128, lon:-74.0060, tz:"America/New_York", population:"349 million", area:"9,833,517 km²",
  ...
  { name:"Japan", lat:35.3606, lon:138.7274, tz:"Asia/Tokyo", population:"122.4 million", area:"377,975 km²",
  ...
  { name:"France", lat:48.8584, lon:2.2945, tz:"Europe/Paris", population:"66.7 million", area:"551,695 km²",
  ...
  { name:"Italy", lat:41.8902, lon:12.4922, tz:"Europe/Rome", population:"58.9 million", area:"302,068 km²",
  ...
  { name:"United Kingdom", lat:51.5007, lon:-0.1246, tz:"Europe/London", population:"69.9 million", area:"244,376 km²",
  ...
  { name:"Australia", lat:-33.8568, lon:151.2153, tz:"Australia/Sydney", population:"27.2 million", area:"7,692,024 km²",
  ...
  { name:"UAE", lat:25.1972, lon:55.2744, tz:"Asia/Dubai", population:"11.6 million", area:"83,600 km²",
  ...
  { name:"Thailand", lat:7.7407, lon:98.7784, tz:"Asia/Bangkok", population:"71.6 million", area:"513,120 km²",
  ...
  { name:"Greece", lat:36.3932, lon:25.4615, tz:"Europe/Athens", population:"9.9 million", area:"131,957 km²",
  ...
  { name:"Iceland", lat:64.0784, lon:-16.2300, tz:"Atlantic/Reykjavik", population:"0.40 million", area:"103,000 km²",
  ...
  { name:"Maldives", lat:4.1755, lon:73.5093, tz:"Indian/Maldives", population:"0.53 million", area:"298 km²",
  ...
  { name:"Switzerland", lat:45.9763, lon:7.6586, tz:"Europe/Zurich", population:"9.0 million", area:"41,291 km²",
  ...
  { name:"Egypt", lat:29.9792, lon:31.1342, tz:"Africa/Cairo", population:"120.1 million", area:"1,010,408 km²",
  ...
  { name:"Spain", lat:41.4036, lon:2.1744, tz:"Europe/Madrid", population:"49.8 million", area:"505,990 km²",
  ...
  { name:"Germany", lat:52.5163, lon:13.3777, tz:"Europe/Berlin", population:"83.6 million", area:"357,592 km²",
  ...
  { name:"Netherlands", lat:52.3676, lon:4.9041, tz:"Europe/Amsterdam", population:"18.4 million", area:"41,850 km²",
  ...
  { name:"Turkey", lat:38.6431, lon:34.8286, tz:"Europe/Istanbul", population:"87.9 million", area:"783,562 km²",
  ...
  { name:"South Korea", lat:37.5796, lon:126.9770, tz:"Asia/Seoul", population:"51.6 million", area:"100,432 km²",
  ...
  { name:"Vietnam", lat:20.9101, lon:107.1839, tz:"Asia/Ho_Chi_Minh", population:"102 million", area:"331,212 km²",
  ...
  { name:"Nepal", lat:27.9881, lon:86.9250, tz:"Asia/Kathmandu", population:"29.6 million", area:"147,516 km²",
  ...
  { name:"Morocco", lat:35.1688, lon:-5.2636, tz:"Africa/Casablanca", population:"38.8 million", area:"446,550 km²",
  ...
  { name:"Russia", lat:55.7558, lon:37.6173, tz:"Europe/Moscow", population:"143 million", area:"17,098,246 km²",
  ...
  { name:"South Africa", lat:-33.9628, lon:18.4098, tz:"Africa/Johannesburg", population:"65.5 million", area:"1,221,037 km²",
  ...
  { name:"Brazil", lat:-22.9519, lon:-43.2105, tz:"America/Sao_Paulo", population:"214 million", area:"8,515,767 km²",
  ...
  { name:"Mexico", lat:20.6843, lon:-88.5678, tz:"America/Mexico_City", population:"133 million", area:"1,964,375 km²",
  ...
  { name:"New Zealand", lat:-44.6710, lon:167.9250, tz:"Pacific/Auckland", population:"5.3 million", area:"268,838 km²",
  ...
  { name:"Jammu", lat:32.7266, lon:74.8570, tz:"Asia/Kolkata", population:"1.53 million (district, 2011 census)", area:"3,097 km²",
  ...
  { name:"Vaishno Devi", lat:33.0303, lon:74.9490, tz:"Asia/Kolkata", population:"1.53 million (Jammu district, 2011 census)", area:"3,097 km² (Jammu district)",
  ...
  { name:"Canada", lat:43.0962, lon:-79.0377, tz:"America/Toronto", population:"40.5 million", area:"9,984,670 km²",
  ...
  { name:"Singapore", lat:1.2834, lon:103.8607, tz:"Asia/Singapore", population:"5.9 million", area:"745 km²",
  ...
  { name:"Malaysia", lat:3.1579, lon:101.7116, tz:"Asia/Kuala_Lumpur", population:"36.4 million", area:"330,803 km²",
  ...
  { name:"Indonesia", lat:-7.6079, lon:110.2038, tz:"Asia/Jakarta", population:"288 million", area:"1,904,569 km²",
  ...
  { name:"Portugal", lat:38.6916, lon:-9.216, tz:"Europe/Lisbon", population:"10.4 million", area:"92,212 km²",
  ...
  { name:"Saudi Arabia", lat:24.7136, lon:46.6753, tz:"Asia/Riyadh", population:"35.2 million", area:"2,149,690 km²",
  ...
  { name:"Philippines", lat:9.85, lon:124.1435, tz:"Asia/Manila", population:"118 million", area:"300,000 km²",
  ...
  { name:"Norway", lat:62.1049, lon:7.2062, tz:"Europe/Oslo", population:"5.7 million", area:"323,802 km²",
  ...
  { name:"Ireland", lat:52.9715, lon:-9.4309, tz:"Europe/Dublin", population:"5.4 million", area:"70,273 km²",
  ...
  { name:"Croatia", lat:42.6507, lon:18.0944, tz:"Europe/Zagreb", population:"3.8 million", area:"56,594 km²",
  ...
  { name:"Pakistan", lat:31.588, lon:74.3095, tz:"Asia/Karachi", population:"259 million", area:"881,913 km²",
  ...
  { name:"Qatar", lat:25.2854, lon:51.531, tz:"Asia/Qatar", population:"3.2 million", area:"11,586 km²",
  ...
  { name:"Jordan", lat:30.3285, lon:35.4444, tz:"Asia/Amman", population:"11.6 million", area:"89,342 km²",
  ...
  { name:"Peru", lat:-13.1631, lon:-72.545, tz:"America/Lima", population:"34.9 million", area:"1,285,216 km²",
  ...
  { name:"Argentina", lat:-50.4967, lon:-73.1387, tz:"America/Argentina/Buenos_Aires", population:"46.0 million", area:"2,780,400 km²",
  ...
  { name:"Colombia", lat:10.391, lon:-75.4794, tz:"America/Bogota", population:"53.9 million", area:"1,141,748 km²",
  ...
  { name:"Chile", lat:-27.1127, lon:-109.3497, tz:"America/Santiago", population:"19.9 million", area:"756,096 km²",
  ...
  { name:"Nigeria", lat:6.5244, lon:3.3792, tz:"Africa/Lagos", population:"242 million", area:"923,768 km²",
  ...
  { name:"Ghana", lat:5.1053, lon:-1.2466, tz:"Africa/Accra", population:"35.7 million", area:"238,533 km²",
  ...
  { name:"Kenya", lat:-1.5, lon:35.1, tz:"Africa/Nairobi", population:"58.6 million", area:"580,367 km²",
  ...
  { name:"Tanzania", lat:-3.0674, lon:37.3556, tz:"Africa/Dar_es_Salaam", population:"72.6 million", area:"947,303 km²",
  ...
  { name:"Sri Lanka", lat:7.957, lon:80.7603, tz:"Asia/Colombo", population:"23.3 million", area:"67,240 km²",
  ...
  { name:"Cuba", lat:23.1367, lon:-82.3589, tz:"America/Havana", population:"10.9 million", area:"109,884 km²",
  ...
  { name:"Ladakh", lat:33.7527, lon:78.6584, tz:"Asia/Kolkata", population:"274,289 (UT, 2011 census)", area:"59,146 km²",
  ...
  { name:"Uttarakhand", lat:30.7346, lon:79.0669, tz:"Asia/Kolkata", population:"10.09 million (state, 2011 census)", area:"53,483 km²",
  ...
  { name:"Himachal Pradesh", lat:32.219, lon:76.3234, tz:"Asia/Kolkata", population:"6.86 million (state, 2011 census)", area:"55,673 km²",
  ...
  { name:"Kullu", lat:31.9576, lon:77.1095, tz:"Asia/Kolkata", population:"18,536 (town, 2011 census)", area:"5,503 km² (district)",
  ...
  { name:"Manali", lat:32.2432, lon:77.1892, tz:"Asia/Kolkata", population:"8,096 (town, 2011 census)", area:"Kullu district",
  ...
  { name:"Srinagar", lat:34.0837, lon:74.7973, tz:"Asia/Kolkata", population:"1.27 million (district, 2011 census)", area:"1,979 km² (district)",
  ...
  { name:"Pahalgam", lat:34.0161, lon:75.3152, tz:"Asia/Kolkata", population:"9,264 (town, 2011 census)", area:"Anantnag district",
  ...
  { name:"Patnitop", lat:33.0903, lon:75.3264, tz:"Asia/Kolkata", population:"No separate census count (hill resort)", area:"Udhampur district",
  ...
  { name:"Shimla", lat:31.1048, lon:77.1734, tz:"Asia/Kolkata", population:"169,578 (city, 2011 census)", area:"25 km² (town)",
  ...
  { name:"Kinnaur Kailash", lat:31.53, lon:78.25, tz:"Asia/Kolkata", population:"19,190 (Kalpa tehsil, 2011 census)", area:"Kinnaur district",
    winter:"-10–2°C", summer:"10–22°C",
    photo:"https://commons.wikimedia.org/wiki/Special:FilePath/Kinnaur_Kailash_Shivling_and_Kinnaur_kailash_with_Top_of_Kalpa_Temple_Photographed_by_Sumita_Roy.jpg?width=1400",
  ...
  { name:"Shrikhand Mahadev", lat:31.8464, lon:77.7396, tz:"Asia/Kolkata", population:"Uninhabited (pilgrimage trek)", area:"Kullu district",
    ...
    photo:"https://commons.wikimedia.org/wiki/Special:FilePath/Shrikhand_Mahadev.jpg?width=1400",
    blurb:"One of India's toughest treks, climbing to a 75-foot natural Shivling at 18,570 feet in the Kullu Himalayas." },
  { name:"Kasol", lat:32.01, lon:77.3145, tz:"Asia/Kolkata", population:"No separate census count (small village)", area:"Parvati Valley",
  ...
  { name:"Sonamarg", lat:34.302, lon:75.2933, tz:"Asia/Kolkata", population:"392 (seasonal, 2011 census)", area:"Ganderbal district",
  ...
  { name:"Bangladesh", lat:22.4953, lon:89.5403, tz:"Asia/Dhaka", population:"178 million", area:"148,460 km²",
  ...
  { name:"Cambodia", lat:13.4125, lon:103.867, tz:"Asia/Phnom_Penh", population:"18.1 million", area:"181,035 km²",
...
/* =========================================================
   SHREE GANESH GLASS HOUSE — LOCAL DESTINATION
   This is intentionally a standalone place so its own photo is used
   as the full panel background when searched, while the normal Jammu
   country entry remains untouched.
========================================================= */
const SHREE_GANESH_GLASS_HOUSE = {
  name:"Shree Ganesh Glass House — Kot Bhalwal",
  lat:32.8120, lon:74.8188, tz:"Asia/Kolkata",
  population:"—", area:"Kot Bhalwal, Jammu",
  winter:"—", summer:"—",
  photo:"./shreeganesh-glass-house-kot-bhalwal.jpg",
  directionsUrl:"https://www.google.com/maps/dir/?api=1&destination=Shree%20Ganesh%20Glass%20House%2C%20Kot%20Bhalwal%2C%20Jammu",
  blurb:"Shree Ganesh Glass House, Kot Bhalwal near Ring Road, Jammu.",
  dynamic:false,
  isLocalPlace:true
};
...
COUNTRIES.forEach(c=>{
  ...
  // Larger invisible hit target keeps country selection easy on mobile without
  // changing the visible marker size.
...
function setRotateMode(on){
  ...
  canvas.style.touchAction = rotateMode ? 'none' : 'manipulation';
...
// Header controls: globe toggles Explore mode; hamburger opens the mobile nav.
(function initHeaderControls(){
  const globeBtn = document.getElementById('globeNavBtn');
  const menuBtn = document.getElementById('menuNavBtn');
  const navLinks = document.querySelector('.nav-links');
  if(globeBtn){
    globeBtn.addEventListener('click', ()=>{
      if(rotateMode) lockExplore(); else unlockExplore();
      globeBtn.classList.toggle('is-active', rotateMode);
      globeBtn.setAttribute('aria-pressed', String(rotateMode));
      globeBtn.title = rotateMode ? 'Exit Explore mode' : 'Enter Explore mode';
    });
  }
  if(menuBtn && navLinks){
    menuBtn.addEventListener('click', ()=>{
      ...
      menuBtn.title = open ? 'Close navigation menu' : 'Open navigation menu';
    });
...
canvas.addEventListener('pointerdown', (e)=>{
  if(e.pointerType === 'touch'){
    ...
    // A second finger belongs to pinch-zoom, never to double-tap detection.
  ...
  // Double-tap is the ONLY way to toggle globe controls. Prevent the browser's
  // own double-tap page zoom and keep the gesture for Musafir.
  if(isDoubleTap){
    e.preventDefault();
    if(rotateMode) lockExplore();
    else unlockExplore();
    const headerGlobe = document.getElementById('globeNavBtn');
    if(headerGlobe){ headerGlobe.classList.toggle('is-active', rotateMode); headerGlobe.setAttribute('aria-pressed', String(rotateMode)); }
    dragging = false;
    activePointerId = null;
    return;
  }
...
function raycastMarker(clientX, clientY){
  ...
  const hits = raycaster.intersectObjects(markerHitTargets);
  if(!hits.length) return null;

  // Only allow markers on the visible hemisphere to be selected.
  const camWorld = new THREE.Vector3(0,0,1);
  for(const hit of hits){
    const worldPos = hit.object.getWorldPosition(new THREE.Vector3()).normalize();
    if(worldPos.dot(camWorld) > 0.18) return hit.object;
  }
  return null;
}
...
const placeTagEls = COUNTRIES.map(c => {
  ...
  // Country labels are visual overlays only. Let pointer/touch input reach the
  // globe canvas so dragging the globe can never be mistaken for a country tap.
  // Country selection is handled by the canvas raycast on a genuine tap.
...
// Auto-spin direction: 1 = left → right (west → east), -1 = right → left
const GLOBE_SPIN_DIR = 1;
let spinSign = 1;
...
function animate(){
  ...
  if(autoRotate && !flying){
    // If fly-to / dragging left the globe upside-down, its own axis points down and the spin
    // would run backwards on screen — detect that and flip the sign so it always goes left → right.
    const upY = new THREE.Vector3(0,1,0).applyQuaternion(globeGroup.quaternion).y;
    if(Math.abs(upY) > 0.08) spinSign = upY > 0 ? 1 : -1;
    globeGroup.quaternion.multiply(new THREE.Quaternion().setFromAxisAngle(new THREE.Vector3(0,1,0), 0.0016 * spinSign * GLOBE_SPIN_DIR));
...
async function geocodeWeatherPlace(query){
  try{
    ...
    const fullName = [r.name, r.admin1, r.country].filter(Boolean).filter((v,i,a)=>a.indexOf(v)===i).join(', ');
    const key = (r.name || '').toLowerCase();
    const photoMap = {
      jammu:'https://commons.wikimedia.org/wiki/Special:FilePath/Bahu_Fort_Jammu.jpg?width=1400',
      srinagar:'https://commons.wikimedia.org/wiki/Special:FilePath/Dal_Lake_Hazratbal_Srinagar.jpg?width=1400',
      pahalgam:'https://commons.wikimedia.org/wiki/Special:FilePath/Pahalgam_views_33.JPG?width=1400',
      patnitop:'https://commons.wikimedia.org/wiki/Special:FilePath/Snowpeaks_Patnitop.jpg?width=1400',
      shimla:'https://commons.wikimedia.org/wiki/Special:FilePath/Christ_Church%2C_Mall_Road%2C_Shimla.jpg?width=1400',
      manali:'https://commons.wikimedia.org/wiki/Special:FilePath/Manali%2C_Himachal_Pradesh.jpg?width=1400',
      leh:'https://commons.wikimedia.org/wiki/Special:FilePath/Leh_Ladakh.jpg?width=1400',
      amritsar:'https://commons.wikimedia.org/wiki/Special:FilePath/Golden_Temple_Amritsar_India.jpg?width=1400',
      mumbai:'https://commons.wikimedia.org/wiki/Special:FilePath/Gateway_of_India_Mumbai_03-2016.jpg?width=1400',
      kolkata:'https://commons.wikimedia.org/wiki/Special:FilePath/Victoria_Memorial_Kolkata.jpg?width=1400',
      hyderabad:'https://commons.wikimedia.org/wiki/Special:FilePath/Charminar_Hyderabad_1.jpg?width=1400',
      jaipur:'https://commons.wikimedia.org/wiki/Special:FilePath/Amber_Fort-Jaipur-India0010.JPG?width=1400',
      ahmedabad:'https://commons.wikimedia.org/wiki/Special:FilePath/Sabarmati_Ashram_Ahmedabad.jpg?width=1400',
      bengaluru:'https://commons.wikimedia.org/wiki/Special:FilePath/Vidhana_Soudha_Bangalore.jpg?width=1400',
      goa:'https://commons.wikimedia.org/wiki/Special:FilePath/Baga_Beach_Goa.jpg?width=1400',
      'kinnaur kailash':'https://commons.wikimedia.org/wiki/Special:FilePath/Kinnaur_Kailash_Shivling_and_Kinnaur_kailash_with_Top_of_Kalpa_Temple_Photographed_by_Sumita_Roy.jpg?width=1400',
      'shrikhand mahadev':'https://commons.wikimedia.org/wiki/Special:FilePath/Shrikhand_Mahadev.jpg?width=1400'
    };
    return {
      name: fullName, lat:r.latitude, lon:r.longitude, tz:r.timezone || '',
      photo:photoMap[key] || '', dynamic:true,
      blurb:`Live weather lookup for ${fullName}.`
    };
  }catch(e){ return null; }
}
...
async function doWeatherSearch(){
  ...
  if(!val) return;
  msg.textContent = 'Checking live weather…';

  const allWeatherPlaces = [];
  COUNTRIES.forEach(c=>{
    allWeatherPlaces.push(c);
    (c.places||[]).forEach(p=>allWeatherPlaces.push({...c,...p,name:p.name,displayName:`${p.name}, ${c.name}`,blurb:p.blurb||c.blurb,dynamic:true}));
  });
  const match = allWeatherPlaces.find(c=>c.name.toLowerCase()===val) ||
                allWeatherPlaces.find(c=>c.name.toLowerCase().includes(val));
  if(match){ msg.textContent=''; loadWeatherSingle(match); return; }

  const place = await geocodeWeatherPlace(input.value.trim());
  if(place){ msg.textContent=''; loadWeatherSingle(place); return; }

  msg.textContent = `"${input.value.trim()}" not found — try a city, district, state, province, territory or country.`;
}
...
function panelLocationLabel(country){
  const map={
    'Kinnaur Kailash':'Kinnaur, Himachal Pradesh, India',
    'Shrikhand Mahadev':'Kullu, Himachal Pradesh, India',
    'Manimahesh':'Chamba, Himachal Pradesh, India',
    'Patnitop':'Udhampur, Jammu and Kashmir, India',
    'Nathatop':'Udhampur, Jammu and Kashmir, India',
    'Pahalgam':'Anantnag, Jammu and Kashmir, India',
    'Dal Lake':'Srinagar, Jammu and Kashmir, India',
    'Srinagar':'Jammu and Kashmir, India',
    'Jammu':'Jammu and Kashmir, India',
    'Shimla':'Himachal Pradesh, India',
    'Triyund':'Kangra, Himachal Pradesh, India',
    'Kasol':'Kullu, Himachal Pradesh, India',
    'Sonamarg':'Ganderbal, Jammu and Kashmir, India',
    'Anantnag':'Jammu and Kashmir, India'
  };
  return map[country.name] || (country.isLocalPlace ? 'Kot Bhalwal, Jammu, Jammu and Kashmir, India' : '');
}
...
function openPanel(country){
  ...
  document.getElementById('panelEyebrow').textContent = panelLocationLabel(country) || 'NOW VIEWING';
...
function closePanel(){
  // Always unlock the page first, then return to the actual top/home position.
  clearInterval(clockTimer);
  autoRotate = true;
  flying = false;
  dragging = false;
  ...
  const goHome = ()=>{
    ...
    const home = document.querySelector('.hero') || document.querySelector('header') || document.querySelector('main') || document.body;
    if(home && home.scrollIntoView) home.scrollIntoView({block:'start', inline:'nearest', behavior:'auto'});
    window.scrollTo(0, 0);
  };
...
const PEOPLE_ALIASES = {
  ...
  "kuldeep singh":"Kuldeep Singh", "kuldeep":"Kuldeep Singh",
...
function findPlaceSearch(raw){
  const key = normalizeSearch(raw);
  const aliases = [
    'shreeganeshglasshouse',
    'shreeganeshglasshousekotbhalwal',
    'ganeshglasshouse',
    'glasshouse',
    'ganesh'
  ];
  if(!aliases.some(a => key === a || key.includes(a))) return null;
  return SHREE_GANESH_GLASS_HOUSE;
}
...
async function doSearch(){
  ...
  // Main search: Shree Ganesh Glass House aliases must resolve before the people search.
  const placeMatch = findPlaceSearch(raw);
  if(placeMatch){
    document.getElementById('searchMsg').textContent = '';
    document.getElementById('searchInput').value = '';
    // Open the local destination itself so panelImg uses the Shree Ganesh photo.
    flyTo(placeMatch);
    return;
  }
...
// Stats count-up animation — starts from 0 and counts steadily when the stats enter view.
(function initStatsCountUp(){
  ...
  function animateNumber(el){
    ...
    const duration = 3600; // deliberately slower, cinematic count
...
/* =========================================================
   STORM FX — light rain + lightning, upper-left of the globe
========================================================= */
(function(){
  const box = document.getElementById('storm-fx');
  if(!box || (window.matchMedia && matchMedia('(prefers-reduced-motion: reduce)').matches)) return;
  const cv = box.querySelector('canvas'), cx = cv.getContext('2d');
  const dpr = Math.min(window.devicePixelRatio || 1, 2);
  let W = 0, H = 0, drops = [], ev = null, visible = true, last = performance.now(), next = last + 2200;

  const mk = rand => ({ x:Math.random()*(W+60)-60, y:rand ? Math.random()*H : -20, l:9+Math.random()*14, v:420+Math.random()*380, a:.12+Math.random()*.24 });
  function size(){
    W = box.clientWidth; H = box.clientHeight;
    if(!W || !H) return;
    cv.width = W*dpr; cv.height = H*dpr; cx.setTransform(dpr,0,0,dpr,0,0);
    drops = []; for(let i=0, n=Math.round(W*H/1900); i<n; i++) drops.push(mk(true));
  }
  function makeBolt(){
    let x = W*(.14+Math.random()*.24), y = H*.04;
    const ty = H*(.7+Math.random()*.2), pts = [[x,y]];
    while(y<ty){ y += 9+Math.random()*13; x += (Math.random()-.42)*22; pts.push([x,y]); }
    const k = 2+Math.floor(Math.random()*(pts.length-4)), dir = Math.random()<.5 ? -1 : 1;
    let bx = pts[k][0], by = pts[k][1]; const br = [[bx,by]];
    for(let i=0;i<4;i++){ by += 10+Math.random()*14; bx += dir*(6+Math.random()*16); br.push([bx,by]); }
    return { main:pts, branch:br, x:pts[0][0] };
  }
  const seq = [[0,60,1],[60,110,.15],[110,200,.7],[200,240,.1],[240,360,.95]];
  function inten(t){
    for(const s of seq) if(t>=s[0] && t<s[1]) return s[2];
    return t<800 ? .5*Math.pow(1-(t-360)/440,2) : 0;
  }
  function stroke(pts, scale){
    cx.beginPath(); cx.moveTo(pts[0][0], pts[0][1]);
    for(let i=1;i<pts.length;i++) cx.lineTo(pts[i][0], pts[i][1]);
    [[9,'rgba(90,130,255,.18)'],[4,'rgba(150,190,255,.45)'],[1.6,'rgba(235,245,255,.95)']].forEach(l=>{
      cx.lineWidth = l[0]*scale; cx.strokeStyle = l[1]; cx.stroke();
    });
  }
  function frame(now){
    ...
    let I = 0;
    if(!ev && now>=next) ev = { t:now, bolt: Math.random()<.75 ? makeBolt() : null };
    if(ev){ I = inten(now-ev.t); if(now-ev.t>800){ ev = null; I = 0; next = now+4500+Math.random()*4500; } }
    cx.globalCompositeOperation = 'source-over'; cx.lineCap = 'round'; cx.lineWidth = 1;
    for(let i=0;i<drops.length;i++){
      let d = drops[i]; d.y += d.v*dt; d.x += d.v*dt*.18;
      if(d.y>H+20 || d.x>W+40){ drops[i] = d = mk(false); }
      cx.strokeStyle = 'rgba(175,198,235,'+Math.min(.6, d.a*(1+I*.9)).toFixed(3)+')';
      cx.beginPath(); cx.moveTo(d.x, d.y); cx.lineTo(d.x-d.l*.18, d.y-d.l); cx.stroke();
    }
    if(ev && I>0){
      const gx = ev.bolt ? ev.bolt.x : W*.25, g = cx.createRadialGradient(gx,H*.04,0,gx,H*.04,W*.9);
      g.addColorStop(0,'rgba(170,200,255,'+(.34*I).toFixed(3)+')'); g.addColorStop(1,'rgba(170,200,255,0)');
      cx.globalCompositeOperation = 'lighter'; cx.fillStyle = g; cx.fillRect(0,0,W,H);
      if(ev.bolt){
        cx.globalAlpha = Math.min(1,I); cx.lineJoin = 'round'; cx.shadowBlur = 18; cx.shadowColor = '#7aa2ff';
        stroke(ev.bolt.main,1); stroke(ev.bolt.branch,.6);
...
/* =========================================================
   REVIEWS — visitors post (with optional photos); the owner approves
   them in /admin.html before they show up here. Backend: /api/reviews
========================================================= */
(function(){
  const form = document.getElementById('rvForm'); if(!form) return;
  const $ = id => document.getElementById(id);
  const list=$('rvList'), msg=$('rvMsg'), sum=$('rvSummary'), starsEl=$('rvStars'), btn=$('rvBtn'), prev=$('rvPrev'), fileIn=$('rvPhotos');
  let rating=0, photos=[];
  ...
  function card(r){
    ...
    const s=document.createElement('div'); s.className='stars'; s.textContent='★'.repeat(r.rating)+'☆'.repeat(5-r.rating);
    const p=document.createElement('p'); p.textContent='"'+r.text+'"';
    c.append(s,p);
    if(r.photos){
      const ph=document.createElement('div'); ph.className='rv-photos';
      for(let i=0;i<r.photos;i++){ const a=document.createElement('a'), im=document.createElement('img');
        a.href=im.src='/api/reviews?photo='+r.id+'&i='+i; a.target='_blank'; a.rel='noopener'; im.loading='lazy'; im.alt='Traveler photo'; a.append(im); ph.append(a); }
      c.append(ph);
    }
    const w=document.createElement('div'); w.className='reviewer';
    const a=document.createElement('div'); a.className='avatar'; a.textContent=ini(r.name);
    const d=document.createElement('div'), n=document.createElement('div'), l=document.createElement('div');
    n.className='rname'; n.textContent=r.name; l.className='rloc'; l.textContent=r.place||'';
    d.append(n,l); w.append(a,d); c.append(w); return c;
  }
  const VISIBLE_COUNT = 6; // keep the page short: only 6 up top, rest go inside the popup box

  // Curated starter reviews — shown until real traveler reviews fill their spots.
  // Top 3 slots are always these international picks; the other 3 slots are the newest real reviews.
  const FIXED_TOP = [
    { name:'Daniel Cole',    place:'London, UK',       rating:5, text:"Cleanest travel concept site I've used this year. The drag-to-rotate globe alone is worth the visit." },
    { name:'Yuki Tanaka',    place:'Osaka, Japan',      rating:5, text:"I work in travel tech myself and still got surprised — dragging the globe to find a country feels more natural than typing a search box ever did." },
    { name:'Camila Oliveira',place:'São Paulo, Brazil', rating:5, text:"Found Iguaçu Falls on the globe before I even knew it bordered my own country. Small detail, but it made the whole site feel alive." }
  ];
  // These fall back into the "more" box once there are enough real reviews to fill their spots.
  const FIXED_EXTRA = [
    { name:'Ritika Sharma', place:'Delhi, India',            rating:5, text:"Spun the globe, landed on Iceland, and the local time plus the photo made it feel real before I'd even booked anything." },
    { name:'Meera Nair',    place:'Bengaluru, India',        rating:4, text:"Asked the Musafir AI about the Maldives and it answered faster and better than most travel agents I've called." },
    { name:'Vikram Anand',  place:'HCLTech, Delhi, India',   rating:5, text:"Our team at HCLTech uses this to scout destinations for offsites — the live weather and timezone data saves us a dozen separate searches." }
  ];

  const moreWrap=$('rvMoreWrap'), moreBtn=$('rvMoreBtn');
  const modal=$('rvModal'), modalList=$('rvModalList'), modalClose=$('rvModalClose'), modalTitle=$('rvModalTitle');
  function openModal(rest){
    modalTitle.textContent = rest.length+' more review'+(rest.length>1?'s':'');
    modalList.replaceChildren(...rest.map(card));
    modal.hidden = false;
  ...
  function render(dynamicItems){
    // 3 international picks always on top, then the 3 newest real reviews next to them
    const newest3 = dynamicItems.slice(0,3);
    const top = FIXED_TOP.concat(newest3);
    // everything older, plus the other curated reviews, live inside the box
    const rest = dynamicItems.slice(3).concat(FIXED_EXTRA);

    list.replaceChildren(...top.map(card));

    const all = FIXED_TOP.concat(FIXED_EXTRA, dynamicItems);
    sum.textContent = all.length
      ? (all.reduce((a,r)=>a+r.rating,0)/all.length).toFixed(1)+' ★ · '+all.length+' traveler review'+(all.length>1?'s':'')
      : 'Be the first to review Musafir';

    if(moreWrap){
      if(rest.length){
        moreWrap.hidden = false;
        moreBtn.textContent = 'Show '+rest.length+' more review'+(rest.length>1?'s':'');
        moreBtn.onclick = ()=>openModal(rest);
      } else {
  ...
  async function load(){
    try{
      ...
      const items = r.ok ? ((await r.json()).reviews||[]) : [];
      items.sort((a,b)=>(b.ts||0)-(a.ts||0)); // newest review first, older ones fall into the box
      render(items);
    }
    catch(_){ render([]); }
  }
  function paint(){ [...starsEl.children].forEach(b=>b.classList.toggle('on',+b.dataset.v<=rating)); }
  starsEl.addEventListener('click',e=>{ const b=e.target.closest('button'); if(!b) return; rating=+b.dataset.v; paint(); });

  // photos: resize + compress in the browser so uploads stay small
  function shrink(file){
    return new Promise((ok,bad)=>{
      ...
      img.onload=()=>{
        ...
        let q=.78, d=c.toDataURL('image/jpeg',q);
        while(d.length>220000 && q>.35){ q-=.08; d=c.toDataURL('image/jpeg',q); }
        d.length>236000 ? bad() : ok(d);
      };
      img.onerror=bad; img.src=u;
    });
  }
  function drawPrev(){
    prev.replaceChildren(...photos.map((src,i)=>{
      const w=document.createElement('div'), im=document.createElement('img'), x=document.createElement('button');
      im.src=src; x.type='button'; x.textContent='×'; x.setAttribute('aria-label','Remove photo');
      x.onclick=()=>{ photos.splice(i,1); drawPrev(); }; w.append(im,x); return w;
    }));
  }
  fileIn.addEventListener('change', async ()=>{
    for(const f of [...fileIn.files]){
      if(photos.length>=3){ say('You can add up to 3 photos.',true); break; }
      try{ photos.push(await shrink(f)); }catch(_){ say('Could not read one of the photos.',true); }
    }
    fileIn.value=''; drawPrev();
  });

  form.addEventListener('submit', async e=>{
    e.preventDefault();
    const name=$('rvName').value.trim(), place=$('rvPlace').value.trim(), text=$('rvText').value.trim();
    if(name.length<2||text.length<5) return say('Please add your name and a short review.',true);
    if(!rating) return say('Please tap a star rating.',true);
    btn.disabled=true; say('Posting…');
    try{
      const r=await fetch('/api/reviews',{method:'POST',headers:{'Content-Type':'application/json'},
        body:JSON.stringify({name,place,text,rating,photos,website:$('rvWeb').value})});
      const j=await r.json().catch(()=>({}));
      if(r.ok){ form.reset(); rating=0; photos=[]; paint(); drawPrev(); say('Thank you! Your review will appear once it is approved.'); }
      else say(r.status===503 ? 'Reviews are not connected yet. Please try again later.' : (j.error||'Could not post your review.'), true);
    }catch(_){ say('Network problem. Please try again.', true); }
    btn.disabled=false;
  });
  load();
})();
