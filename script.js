...
if(panelCloseBtn){
  ...
  panelCloseBtn.addEventListener('click', closeFromUser);
  panelCloseBtn.addEventListener('pointerup', closeFromUser);
  panelCloseBtn.addEventListener('touchend', closeFromUser, {passive:false});
}
