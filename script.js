...
const COUNTRIES = [
  ...
  { name:"Jammu", lat:32.7266, lon:74.8570, tz:"Asia/Kolkata", population:"1.5 million (district)", area:"3,097 km²",
    ...
    places:[{ name:"Shree Ganesh Glass House — Kot Bhalwal", lat:32.8120, lon:74.8188, photo:"./shreeganesh-glass-house-kot-bhalwal.jpg", directionsUrl:"https://www.google.com/maps/dir/?api=1&destination=Shree%20Ganesh%20Glass%20House%2C%20Kot%20Bhalwal%2C%20Jammu", blurb:"Photo destination: Shree Ganesh Glass House, Kot Bhalwal near Ring Road, Jammu." }]
  },
...
window.addEventListener('pointerup', (e)=>{
  // Marker taps are enabled only while rotate mode is ON. Normal page scrolling/taps stay passive.
  const tapDt = performance.now()-tapDownTime;
  if(rotateMode && !tapMoved && tapDt < 400 && !flying){
    const hit = raycastMarker(e.clientX, e.clientY);
